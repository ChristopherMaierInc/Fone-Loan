...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post conversations_url, params: { conversation: { user1_id: @conversation.user1_id, user2_id: @conversation.user2_id } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { user1_id: @conversation.user1_id, user2_id: @conversation.user2_id } }
