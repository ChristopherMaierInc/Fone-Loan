...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { brand: @phone.brand, condition: @phone.condition, model: @phone.model, priceperweek: @phone.priceperweek } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { brand: @phone.brand, condition: @phone.condition, model: @phone.model, priceperweek: @phone.priceperweek } }
